import svgPaths from "./svg-vx665imjos";
...
import imgImage1 from "figma:asset/543867f57611da342869e6a0e5da677afdb16246.png";
import imgImage2 from "figma:asset/29c42333eb014ea2c1222b04eb8ec8cf1e019082.png";
import imgImage3 from "figma:asset/1f52b68b3aff772b74c7847d2532f1d01ee9fe7a.png";
...
function Frame125() {
  return (
    <div className="absolute h-[66px] left-0 overflow-clip top-[8px] w-[1440px]">
      ...
      <Frame138 />
      <Frame128 />
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.006328986957669258)+(var(--transform-inner-height)*0.9999799728393555)))] items-center justify-center left-[235px] top-[49px] w-[calc(1px*((var(--transform-inner-height)*0.006328986957669258)+(var(--transform-inner-width)*0.9999799728393555)))]" style={{ "--transform-inner-width": "158", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[0.363deg]">
          <div className="h-0 relative w-[158.003px]">
            <div className="absolute inset-[-2.5px_-1.58%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 164 6">
                <path d="M3 3H161.003" id="Vector 3" stroke="var(--stroke-0, #00FF00)" strokeLinecap="round" strokeWidth="5" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame132() {
  return (
    <div className="absolute h-[196px] left-[157px] overflow-clip top-[113px] w-[392px]">
      <div className="absolute h-[196px] left-0 top-0 w-[392px]" data-name="image 1">
...
function Frame136() {
  return (
    <div className="absolute h-[196px] left-[983px] overflow-clip top-[113px] w-[392px]">
      <div className="absolute h-[196px] left-0 top-0 w-[392px]" data-name="image">
...
function Frame135() {
  return (
    <div className="absolute h-[196px] left-[570px] overflow-clip top-[113px] w-[392px]">
      <div className="absolute h-[196px] left-0 top-0 w-[392px]" data-name="image">
...
function Frame133() {
  return <div className="absolute h-[196px] left-[157px] top-[113px] w-[392px]" />;
}

function Frame131() {
  return (
    <div className="absolute h-[383px] left-0 overflow-clip top-[14px] w-[1440px]">
      <p className="absolute font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[normal] left-[155px] text-[30px] text-black text-nowrap top-[32px] whitespace-pre">Khuyến mãi hiện hành</p>
      <p className="absolute font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[normal] left-[155px] text-[20px] text-[grey] text-nowrap top-[70px] whitespace-pre">Tiết kiệm lớn với những ưu đãi đặc biệt giới hạn</p>
      <Frame132 />
      <Frame136 />
      <Frame135 />
...
export default function TtCHotDng() {
  return (
    <div className="bg-white relative size-full" data-name="Tất cả hoạt động">
      <DesktopFooter />
      <Frame122 />
      <Frame123 />
      <Frame124 />
