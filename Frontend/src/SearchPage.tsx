...
import { ArrowRightLeft, ThumbsUp, Zap, DollarSign, PlaneTakeoff, PlaneLanding, Calendar, User, Search, Plane, ChevronDown } from "lucide-react";
...
// Flight Card
function FlightCard({ type = "single", onNavigate }: { type?: "single" | "round-trip", onNavigate?: (page: string) => void }) {
  return (
      ...
      <div className="bg-[#f3f3f3] min-h-screen py-8">
        <div className="max-w-[1200px] mx-auto px-6 flex gap-8">
          ...
          <div className="flex-1">
            ...
            <FlightCard type="single" onNavigate={onNavigate} />
            <FlightCard type="round-trip" onNavigate={onNavigate} />
            <FlightCard type="single" onNavigate={onNavigate} />
          </div>
