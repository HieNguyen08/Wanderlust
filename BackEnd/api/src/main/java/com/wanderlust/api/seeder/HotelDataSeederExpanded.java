...
/**
 * Extended hotel data seeder with hotels across multiple locations in Vietnam and international destinations.
...
public class HotelDataSeederExpanded {
    ...
    private List<Hotel> generatePhuQuocHotels() {
        ...
        Hotel h1 = createHotel(
            "vendor012", "location_phuquoc", "JW Marriott Phu Quoc Emerald Bay Resort & Spa", "jw-marriott-phu-quoc",
        ...
        Hotel h2 = createHotel(
            "vendor013", "location_phuquoc", "InterContinental Phu Quoc Long Beach Resort", "intercontinental-phu-quoc",
    ...
    private List<Hotel> generateBangkokHotels() {
        ...
        Hotel h3 = createHotel(
            "vendor026", "location_bangkok", "Four Seasons Hotel Bangkok at Chao Phraya River", "four-seasons-bangkok",
    ...
    private Hotel createHotel(String vendorId, String locationId, String name, String slug,
        ...
        hotel.setCheckInTime(LocalTime.of(stars == 5 ? 15 : 14, 0));
        hotel.setCheckOutTime(LocalTime.of(12, 0));
        
        // Standard images
        hotel.setImages(Arrays.asList(
            new Hotel.HotelImage("https://images.unsplash.com/photo-1731080647266-85cf1bc27162?w=1080", "Hotel exterior", 1),
            new Hotel.HotelImage("https://images.unsplash.com/photo-1731336478850-6bce7235e320?w=1080", "Deluxe room", 2),
            new Hotel.HotelImage("https://images.unsplash.com/photo-1623718649591-311775a30c43?w=1080", "Swimming pool", 3)
        ));
        
        hotel.setAmenities(Arrays.asList("Wifi miễn phí", "Hồ bơi", "Spa", "Nhà hàng", "Phòng tập gym", "Dịch vụ phòng"));
    ...
    private List<Room> generateStandardRooms(String hotelId) {
        ...
        room1.setImages(Arrays.asList(
            new Room.RoomImage("https://images.unsplash.com/photo-1731336478850-6bce7235e320?w=800", "Phòng ngủ", 1),
        ...
        room2.setAmenities(Arrays.asList("TV LED 55 inch", "Máy lạnh", "Minibar", "Két sắt", "Bàn làm việc", "Sofa", "Ban công"));
        ...
        room3.setAmenities(Arrays.asList("TV LED 65 inch", "Máy lạnh", "Minibar", "Két sắt", "Bàn làm việc", "Phòng khách", "Ban công lớn", "Máy pha cà phê"));
        ...
        room4.setAmenities(Arrays.asList("2 TV LED", "Máy lạnh", "Minibar", "Két sắt", "Khu vực vui chơi trẻ em", "Tủ lạnh"));
